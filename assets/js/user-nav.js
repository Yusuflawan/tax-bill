          ...
          <div class="collapse navbar-collapse justify-content-between">
            <div class="header-left">
              <div class="header-title">
                <h3 id="header-title" class="mb-0">${headerTitle}</h3>
              </div>
            </div>
...
const getUserDetails = async () => {
  ...
  try {
    const response = await fetch("http://localhost:8080/tax-backend/user/profile", {
      method: "GET",
      headers: {
    ...
    document.querySelector(".header-info2 h4").innerText = user.businessName || "User Name";
