...
const getAgentDetails = async () => {
  ...
  try {
    const response = await fetch("http://localhost:8080/tax-backend/agent/profile", {
      method: "GET",
      headers: {
    ...
    document.querySelector(".header-info2 h4").innerText = agent.firstName + " " + agent.lastName || "Agent Name";
